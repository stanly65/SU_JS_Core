...
function solve(args) {
    ...
    for (let i = 1; i < args.length; i++) {
        ...
        let op = 'Cut';
        let times = 0;
        let cutSize = cut(size); // размера след еднократно рязане
        ...
        op = 'Lap';
        let lapSize = lap(size); // размера след еднократно рязане
        ...
        op = 'Grind';
        let grindSize = grind(size); // размера след еднократно рязане
        ...
        op = 'Etch';
        let etchSize = etch(size); // размера след еднократно рязане
