function calendar([day, month, year]){
    ...
    let today = new Date(year, month-1, day);                                                  //денят даден по условие
    ...
    lastDateOfCalendar.setMonth(lastDateOfCalendar.getMonth()+1);                             //изираме следващия месец
    lastDateOfCalendar.setDate(0);                                  //setDate(0) - последната дата на предишния месец
